...
2) Read the [paper](https://www.sciencedirect.com/science/article/abs/pii/S1364815220307751) for a more scientific background, or study the vignettes on [the arealDB pipeline](https://luckinet.github.io/arealDB/articles/arealDB.html) and [an in depth](https://luckinet.github.io/arealDB/articles/technical_details.html) explanation of the underlying procedures.
...
For an in-depth example-run of the pipeline, consult [this vignette](https://luckinet.github.io/arealDB/articles/arealDB.html) and for details on the procedures running in the background, consult [this vignette](https://luckinet.github.io/arealDB/articles/technical_details.html).
